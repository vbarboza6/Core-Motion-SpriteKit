...
SWIFT_MODULE_NAMESPACE_PUSH("SpriteKit")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC9SpriteKit11AppDelegate")
...
SWIFT_CLASS("_TtC9SpriteKit14ViewController")
@interface ViewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, readonly, strong) CMMotionActivityManager * _Nonnull activityManager;
